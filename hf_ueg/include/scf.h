...
class Scf {
    ...
    //make a function that generates a guess of zeros for the density matrix
    arma::mat zeros_guess();
    //make a function that generates a guess of the identity matrix for the density matrix
